                                ...
                                <div key={order.id} className="order-card">
                                    <div className="order-header">
                                        <div className="order-info">
                                            <span className="order-id">Pedido #{order.id.slice(-8).toUpperCase()}</span>
                                    ...
                                    <div className="order-footer">
                                        ...
                                        {order.status === 'pending' && (
                                            <a 
                                                href={`https://wa.me/${import.meta.env.VITE_WHATSAPP_NUMBER || '5491112345678'}?text=Hola,%20quiero%20confirmar%20mi%20pedido%20#${order.id.slice(-8).toUpperCase()}`}
                                                target="_blank"
